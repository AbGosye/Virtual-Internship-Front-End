...
export default function SidenavApplicant() {
  return (
    <div className="">
      <nav className="fixed pt-0 pb-1.5  w-1/6 h-full bg-slate-50 text-white p-4">
        ...
        <ul className="  text-black bg-slate-50 h-3/5 grid place-content-evenly">
          ...
          <li>
            <Link to="/src/Components/Try/Users.jsx">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                fill="currentColor"
