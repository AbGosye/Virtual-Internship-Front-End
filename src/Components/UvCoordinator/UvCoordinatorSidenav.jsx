...
const navigation = [
  { name: "Virtual Internship", href: "#", current: false },
...
export default function UvCoordinatorSidenav() {
  return (
    <div className="">
      <nav className="fixed pt-0 pb-1.5  w-1/6 h-full bg-slate-50 text-white p-4">
        <Disclosure as="nav" className=" block w-screen bg-slate-50">
          {({ open }) => (
            <>
        ...
        <ul className="  text-black bg-slate-50 h-3/5 grid place-content-evenly">
          <li className="inline">
            <Link to="/UvCoordinator">
              {" "}
              <div className="flex">
                <svg
                  ...
                  viewBox="0 0 24 24"
                  fill="currentColor"
                  className="w-5 p-px mr-5 inline h-5"
                >
          ...
          <li>
            <Link to="/UvCoordinator/ViewStudent">
              {" "}
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
          ...
          <li>
            <Link to="/UvCoordinator/RegisterSupervisor">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                fill="currentColor"
